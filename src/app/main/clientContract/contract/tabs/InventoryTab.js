...
<DialogTitle
              ...
              <DialogContent className="pt-16 max-w-480">
                <form
                  action="/"
                  method="POST"
                  className="pt-16"
                  onSubmit={async (e) => {
                    ...
                    const response = await axios.post(
                      `https://www.api.mavenevents.ae/api/contractExtraService`,
                      {
              ...
              <DialogActions>
                  ...
                  onClick={async (e) => {
                    ...
                    const response = await axios.post(
                      `https://www.api.mavenevents.ae/api/contractExtraService`,
                      {
                        contractId: contact.id,
                        serviceName:
                          document.getElementById("serviceTEXTFIELD").value,
                      },
                      {
                        headers: {
                          access_token:
                ...
                <a
                  href="https://wa.me/971524867771"
                  target="_blank"
                  style={{ borderBottom: "0px", background: "transparent" }}
                >
                  <Button
                    onClick={() => dispatch(closeDialog())}
                    color="secondary"
...
<DialogTitle
  ...
  return (
    <>
      {isTabletOrMobile && (
        <div className="inline-block p-24 sm:p-40 text-left print:p-0 max-w-sm overflow-auto">
          <motion.div
            initial={{ opacity: 0, y: 200 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ bounceDamping: 0 }}
          >
            <Card className="max-w-sm p-64 pl-4 pr-4 mx-auto rounded-2xl shadow print:w-auto print:rounded-none print:shadow-none print:bg-transparent">
              <Box
                sx={{
                  borderWidth: 4,
                  borderStyle: "solid",
              ...
              >
                <CardContent className="p-16">
                  <div className="flex items-start justify-between">
                    ...
                    >
                      <div className="flex justify-center items-center w-80 h-80">
                        <img
                          className="w-96 items-center justify-center object-center"
                  ...
                  <div className="flex items-center content-center justify-center underline decoration-[#97A3B6] decoration-1 underline-offset-8 mb-24">
                    <Typography
                      className="text-40 tracking-tight"
                      color="text.secondary"
                    >
                      CONTRACT&nbsp;
                    </Typography>
                    <Typography className="text-40">#{contact.id}</Typography>
                  </div>
                        ...
                        {contact.services.map((element) => {
                          return (
                            <>
                              ...
                              <div
                                className="col-span-1 text-lg font-medium text-center mt-12"
                                style={{ color: "#58ed13" }}
                              >
                                {element.quantity}
                              </div>
                  ...
                  <div className="flex items-center content-center justify-center mb-24">
                    ...
                    >
                      <Button
                        className="justify-center content-center px-14 text-12"
                        onClick={confirmMESSAGES}
                        style={{ color: "black" }}
                      >
                        view Transactions
                      </Button>
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-12 gap-x-4 mt-24">
                          <div
                            className="col-span-8 font-medium text-10"
                            style={{ color: "#94A3B8" }}
                          >
                            SERVICE
                          </div>
                          <div
                            className="font-medium text-[7px] text-center"
                            style={{ color: "#94A3B8" }}
                          >
                            AGR
                          </div>
                          <div
                            className=" col-span-2  font-medium text-[7px] text-center"
                            style={{ color: "#94A3B8" }}
                          >
                            DELIVER
                          </div>
                          ...
                          {contact.decemberService[0] && (
                            <>
                              ...
                              <div
                                className="col-span-1 font-medium text-[7px] "
                                style={{ color: "#94A3B8" }}
                              >
                                BENEFITS
                              </div>
                              ...
                              <div className="col-span-3" />
                              <div
                                className="col-span-1  font-medium text-[7px] text-center"
                                style={{ color: "#94A3B8" }}
                              >
                                STATUS
                              </div>
                  ...
                  {contact.november[0] && (
                    <>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-12 gap-x-4 mt-24">
                          <div
                            className="col-span-8 font-medium text-[7px]"
                            style={{ color: "#94A3B8" }}
                          >
                            SERVICE
                          </div>
                  ...
                  <div className=" ">
                    <div className="flex items-center mt-4">
                      ...
                      >
                        ...
                        bring your unique visions to life. Your collaboration
                        and trust are the cornerstone of our success. Please pay
                        within 30 days.
                      </Typography>
                    </div>
                  </div>
              ...
              >
                <CardContent className="p-36">
                  ...
                  <div className="flex items-center content-center justify-center mb-24">
                    ...
                    >
                      <Button
                        className="justify-center content-center px-14"
                        onClick={confirmMESSAGES}
                        style={{ color: "black" }}
                      >
                        view Transactions
