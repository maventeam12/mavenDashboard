...
function ServicesTable(props) {
  ...
  const services = useSelector(selectContracts);
  ...
  function handleClick(item) {
    props.navigate(`/clientContract/contracts/${item.id}`);
  }
              ...
              .map((n) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="p-4 md:p-16" component="th" scope="row" align="center">
                    {n?.linkToDrive?.length > 30 ? `${n?.linkToDrive?.slice(0, 30)}...`: `${n?.linkToDrive}`}
                    </TableCell>
                    <TableCell className="p-4 md:p-16" component="th" scope="row" align="center">
                    {n?.startDate}
                    </TableCell>
