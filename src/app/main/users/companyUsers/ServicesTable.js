...
import { getCompanyUsers, selectCompanyUsers, selectCompanyUsersSearchText } from '../store/companyUsersSlice';
import ServicesTableHead from './ServicesTableHead';
function ServicesTable(props) {
  const dispatch = useDispatch();
  const services = useSelector(selectCompanyUsers);
  const searchText = useSelector(selectCompanyUsersSearchText);
  ...
  function handleClick(item) {
    props.navigate(`/users/team/${item.id}`);
  }
