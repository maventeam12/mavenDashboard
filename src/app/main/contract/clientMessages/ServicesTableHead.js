...
import { removeClientMessages } from '../store/clientMessagesSlice';
...
function ServicesTableHead(props) {
  ...
  const { selectedClientMessagesIds } = props;
  const numSelected = selectedClientMessagesIds.length;
  ...
  function deleteServices() {
    dispatch(
      removeClientMessages({
        selectedClientMessagesIds,
