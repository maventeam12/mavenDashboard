...
import { getClientExtraServices, selectClients, selectClientsSearchText } from '../store/clientExtraServicesSlice';
    ...
    return (
      ...
      >
        <Typography color="text.secondary" variant="h5">
          There are no Extra Services Requested!
        </Typography>
      </motion.div>
    );
  }
    ...
    <div className="w-full flex flex-col min-h-full">
      <FuseScrollbars className="grow overflow-x-auto">
        <Table stickyHeader className="min-w-xl" aria-labelledby="tableTitle">
          <ServicesTableHead
            selectedClientExtraServicesIds={selected}
            order={order}
              ...
              .map((n) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="p-4 md:p-16" component="th" scope="row" align="center">
                    {n?.serviceName?.length > 50 ? `${n?.serviceName?.slice(0, 50)}...`: `${n?.serviceName}`}
                    </TableCell>
                    <TableCell className="p-4 md:p-16" component="th" scope="row" align="center">
                      {n?.contractId}
                    </TableCell>
