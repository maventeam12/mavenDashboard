...
import { removeClientExtraServices } from '../store/clientExtraServicesSlice';
...
function ServicesTableHead(props) {
  ...
  const { selectedClientExtraServicesIds } = props;
  const numSelected = selectedClientExtraServicesIds.length;
  ...
  function deleteServices() {
    dispatch(
      removeClientExtraServices({
        selectedClientExtraServicesIds,
        ...
        children: (
          <>
            <DialogTitle id="alert-dialog-title">
              Are you sure you want to delete this Extra Service(s)?
            </DialogTitle>
            <DialogActions>
              <Button onClick={() => dispatch(closeDialog())} color="secondary">
                Skip
              </Button>
              <Button onClick={deleteServices} color="secondary" autoFocus>
                confirm
              </Button>
            </DialogActions>
          </>
