...
import { removeCareers } from '../store/careersSlice';
...
function ServicesTableHead(props) {
  ...
  const { selectedCareersIds } = props;
  const numSelected = selectedCareersIds.length;
        ...
        children: (
          <>
            <DialogTitle id="alert-dialog-title">
              Are you sure you want to delete this Career(s)?
            </DialogTitle>
            <DialogActions>
