...
import { removeEventPhotographies } from '../store/eventPhotographiesSlice';
...
function EventsTableHead(props) {
  ...
  const { selectedEventPhotographiesIds } = props;
  const numSelected = selectedEventPhotographiesIds.length;
  ...
  function deleteEvents() {
    dispatch(
      removeEventPhotographies({
        selectedEventPhotographiesIds,
        ...
        children: (
          <>
            <DialogTitle id="alert-dialog-title">
              Are you sure you want to delete this Photography(s)?
            </DialogTitle>
            <DialogActions>
              <Button onClick={() => dispatch(closeDialog())} color="secondary">
                Skip
              </Button>
              <Button onClick={deleteEvents} color="secondary" autoFocus>
                confirm
              </Button>
            </DialogActions>
          </>
