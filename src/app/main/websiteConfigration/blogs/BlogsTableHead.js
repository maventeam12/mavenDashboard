...
import { removeBlogs } from '../store/blogsSlice';
...
function BlogsTableHead(props) {
  ...
  const { selectedBlogsIds } = props;
  const numSelected = selectedBlogsIds.length;
        ...
        children: (
          <>
            <DialogTitle id="alert-dialog-title">
              Are you sure you want to delete this blog(s)?
            </DialogTitle>
            <DialogActions>
